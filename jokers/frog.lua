...
SMODS.Joker{
    ...
    loc_vars = function(self, info_queue, card)
        return {
            vars = { card.ability.extra.ribbit, (G.GAME.probabilities.normal or 1), card.ability.extra.odds }
        }
    end,
    ...
    add_to_deck = function (self, card, from_debuff)
        if not from_debuff then
            ...
            if G.GAME.Num_Frogs then
                G.GAME.Num_Frogs = G.GAME.Num_Frogs + 1
            else
                G.GAME.Num_Frogs = 1
            end
